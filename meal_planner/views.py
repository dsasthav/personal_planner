...
class RecipeCreateView(LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('recipe-detail')  # Assuming you have a recipe-detail URL defined
...
class RecipeUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            context['ingredient_formset'] = RecipeIngredientFormset(self.request.POST, instance=self.object, prefix='ingredient')
        else:
            context['ingredient_formset'] = RecipeIngredientFormset(instance=self.object, prefix='ingredient')
        return context
    ...
    def form_valid(self, form):
        ...
        with transaction.atomic():
            ...
            if ingredient_formset.is_valid():
                for form in ingredient_formset:
                    ingredient = form.save(commit=False)
                    ingredient.recipe = self.object  # Set the relationship to the updated recipe
                    ingredient.save()
